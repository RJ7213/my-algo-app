# ==============================================================================
# MASTER BLUEPRINT V53.2 — FINAL UNIFIED RECOVERY ENGINE (100% WORKING FIXED)
# ==============================================================================
...
if input_password == "Roshan@715":
    ...
    # ==============================================================================
    # 🗂️ THE MULTI-TAB INTERFACE ROUTING (RESTORED & DETACHED)
    # ==============================================================================
    ...
    # --- 🚀 STEP 3: AUTOMATIC SAFE STREAM LOOP (RESTORED LOGIC) ---
    if st.session_state['is_connected'] and st.session_state['smartApi']:
        ...
        while True:
            with dhan_app_canvas.container():
                ...
                time.sleep(1.5)
    else: st.info("⏳ Please click CONNECT from the sidebar to view your Unified Terminal.")
