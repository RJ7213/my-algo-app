# ==============================================================================
# MASTER BLUEPRINT V55.1 — SESSION COMPACT ENGINE (100% INSIDE BOX LOCKED)
# ==============================================================================
...
if input_password == "Roshan@715":
    ...
    with tab1: dhan_app_canvas = st.empty()
    with tab2:
        ...
        while True:
            with dhan_app_canvas.container():
                try:
                    ...
                    # --- ⏰ SMART TIME-ZONE SESSIONS DECODER LOCK ---
                    ...
                    if ltp_res['status'] and res['status'] and res['data']:
                        ...
                        # रीयल-टाइम क्लोजिंग मंदी सिग्नल्स फिक्स (V45.1 Method)
                ...
                if current_time >= m_close or current_time < m_settle: time.sleep(10)
                else: time.sleep(1.5)
