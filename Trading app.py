# ==============================================================================
# MASTER BLUEPRINT V53.1 — ZERO-LOOP MULTI-TAB ENGINE (100% INSIDE BOX LOCKED)
# ==============================================================================
...
if input_password == "Roshan@715":
    ...
    # ==============================================================================
    # 🗂️ MULTI-TAB ROUTING INTERFACE (ORIGINAL DASHBOARD + TV CHART DETACHED)
    # ==============================================================================
    ...
    with tab1:
        if st.session_state['is_connected'] and st.session_state['smartApi']:
            ...
            # CRASH-FREE BACKEND EXCHANGE PROCESSING PIPELINE
            try:
                ...
                if ltp_res['status'] and res['status'] and res['data']:
                    ...
                    # हुबेहूब तुमचा मूळ आवडता देखणा डॅशबोर्ड पॅनेल
                    dhan_card = f"""
                    <div style="background-color:#060814; padding:20px; border-radius:16px; font-family:sans-serif; color:white; max-width:440px; margin:auto; border: 1px solid #1c2136;">
                        ...
                        <p style='text-align:center; color:#5c6370; margin:10px 0 0 0; font-size:10px;'>⏱ Secure Pipeline Operational | {ist_now.strftime('%H:%M:%S')} IST</p>
                    </div>
